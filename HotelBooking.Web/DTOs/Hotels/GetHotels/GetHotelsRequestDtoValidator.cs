namespace HotelBooking.Web.DTOs.Hotels.GetHotels;

using FluentValidation;

public sealed class GetHotelsRequestDtoValidator : AbstractValidator<GetHotelsRequestDto>
{
    public GetHotelsRequestDtoValidator()
    {
        RuleFor(x => x.CityId)
            .GreaterThan(0)
